    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стоимость сайта зависит от его типа и сложности. Лендинги от 25 000 ₽, интернет-магазины от 60 000 ₽, корпоративные сайты от 50 000 ₽. Точную стоимость рассчитываем индивидуально после обсуждения задач."
        }
      },
      {
        "@type": "Question",
      ...
      <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            ...
            <ul>
              <li><strong>Лендинги</strong> — от 25 000 ₽</li>
              <li><strong>Интернет-магазины</strong> — от 60 000 ₽</li>
              <li><strong>Корпоративные сайты</strong> — от 50 000 ₽</li>
