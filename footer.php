<footer class="footer card shadow-sm px-4 mb-4" itemscope itemtype="https://schema.org/Person">
  <div class="container py-3 text-center text-md-start">
    ...
    <div class="row">
      <div class="col-md-6 mb-2 mb-md-0">
        ...
        <meta itemprop="description" content="Самозанятый специалист по веб-разработке и созданию сайтов">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-body text-center">
        <p>
          ...
          <a href="/privacy.php" target="_blank" rel="noopener">Политикой конфиденциальности</a>.
        </p>
      </div>
